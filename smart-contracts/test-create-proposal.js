...
;(async () => {
  try {
    ...
    const result = await vm.run(txFunctionCode, 'vm.js')({
      ...
      nonceAccountId: 'GBQBLB23EFSAZR7Y3Q3Y4WZZR34GLGVKQUIBIJYDJFKLA3LJNSOAVXCC',
      proposalSecret: 'SCCFXEQ6BPGNPTIZPQ63GRUQONKIZF57R2SINSKJSHBTUPMT6NSVEXSA', //GD65STKCCX3DJQYVFJYHQ4DL2DXM6LAD2FQVXMP2KNNUEUYIY7IF6RNF
      ...
      proposalLink: 'https://bit.ly/3GcJYLE'
    })
